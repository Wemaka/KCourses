package com.wemaka.kcourses.data.remote

import com.wemaka.kcourses.data.models.courses.Course
import com.wemaka.kcourses.data.remote.models.CoursesResponse

interface CoursesApi {
    fun getCourses(): CoursesResponse
}

class CoursesApiImpl : CoursesApi {
    companion object {
    ...
    override fun getCourses(): CoursesResponse {
